...
class Xfbin:
    ...
    def sort_pages_by_type(self, type):
        """Sorts the Pages list of this Xfbin by the given type.\n
        Pages that contain at least one chunk of the given type will be moved to the top of the list.\n
        """

        pages = self.get_pages_by_type(type)
